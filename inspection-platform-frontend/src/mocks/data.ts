...
export const mockTasks: InspectionTask[] = [
  {
    ...
    features: {
      ...
      aiAlert: {
        enabled: true,
        alertCount: 3,
        lastAlertTime: '2024-01-15T10:25:00Z',
        alertTypes: ['温度异常', '设备故障'],
      },
      ptzControl: {
        enabled: true,
        presets: [1, 2, 3],
  ...
  },
  {
    ...
    deviceName: '可见光云台',
    route: [
      { lat: 39.9062, lng: 116.4094, timestamp: '2024-01-15T10:05:00Z' },
    ],
    ...
    features: {
      ...
      aiAlert: {
        enabled: true,
        alertCount: 1,
        lastAlertTime: '2024-01-15T10:20:00Z',
        alertTypes: ['人员入侵'],
      },
      ptzControl: {
        enabled: true,
  ...
  },
  {
    ...
    status: 'completed',
    deviceId: 'device-13',
    deviceName: '双镜头云台+声像仪一体云台',
    route: [
      { lat: 39.9122, lng: 116.4154, timestamp: '2024-01-15T09:00:00Z' },
    ],
    targets: [mockTargets[0]],
    ...
    features: {
      ...
      aiAlert: {
        enabled: true,
        alertCount: 5,
        lastAlertTime: '2024-01-15T09:45:00Z',
        alertTypes: ['声音异常', '温度异常', '设备振动'],
      },
      ptzControl: {
        enabled: true,
        presets: [1, 2, 3, 4, 5, 6],
  ...
  },
  {
    ...
    route: [
      { lat: 39.9142, lng: 116.4174, timestamp: '2024-01-15T10:10:00Z' },
    ],
    targets: [mockTargets[1]],
